  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Sanitation Personnel & Crews</h1>
        ...
        {crewMembers.map((crew) => (
          <Card key={crew.id} className="border shadow-xs">
            <CardHeader className="p-4 pb-3">
              ...
              <CardDescription className="text-xs">{crew.email}</CardDescription>
            </CardHeader>
            <CardContent className="p-4 pt-0 space-y-2 text-xs">
              ...
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>Base: {crew.quarter ? crew.quarter.replace("_", " ") : "Municipal Central"}</span>
              </div>
            </CardContent>
          </Card>
        ))}
